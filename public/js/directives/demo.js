...
(function() {
  ...
  angular.module("bitly").run(configureDefaults);
...
(function() {
  angular.module("bitly").directive("demoTrackedTable", demoTrackedTable);
...
(function() {
  angular.module("bitly").directive("demoTrackedTableRow", demoTrackedTableRow);
...
(function() {
  angular.module("bitly").directive("demoTrackedTableCell", demoTrackedTableCell);
